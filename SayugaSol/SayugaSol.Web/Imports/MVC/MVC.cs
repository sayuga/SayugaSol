...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Default
        {
            ...
            {
                public const string CertificationIndex = "~/Modules/Default/Certification/CertificationIndex.cshtml";
            }
            ...
            {
                public const string SkillIndex = "~/Modules/Default/Skill/SkillIndex.cshtml";
            }
        }
