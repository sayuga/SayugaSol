...
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var CertificationForm = (function (_super) {
            __extends(CertificationForm, _super);
            function CertificationForm(prefix) {
                var _this = _super.call(this, prefix) || this;
        ...
        CertificationForm.formKey = 'Default.Certification';
        Default.CertificationForm = CertificationForm;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    var Default;
    (function (Default) {
        ...
        (function (CertificationRow) {
            CertificationRow.idProperty = 'Id';
            CertificationRow.nameProperty = 'Name';
            CertificationRow.localTextPrefix = 'Default.Certification';
            CertificationRow.lookupKey = 'Default.Certification';
            function getLookup() {
                return Q.getLookup('Default.Certification');
            }
            CertificationRow.getLookup = getLookup;
        })(CertificationRow = Default.CertificationRow || (Default.CertificationRow = {}));
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    ...
    (function (Default) {
        ...
        (function (CertificationService) {
            CertificationService.baseUrl = 'Default/Certification';
            [
                'Create',
                'Update',
                'Delete',
                ...
                CertificationService[x] = function (r, s, o) {
                    return Q.serviceRequest(CertificationService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(CertificationService = Default.CertificationService || (Default.CertificationService = {}));
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var ContactsForm = (function (_super) {
...
(function (SayugaSol) {
    ...
    (function (Default) {
        ...
        (function (ContactsRow) {
            ...
            ContactsRow.nameProperty = 'LastName';
...
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var SkillForm = (function (_super) {
            __extends(SkillForm, _super);
            function SkillForm(prefix) {
                var _this = _super.call(this, prefix) || this;
                if (!SkillForm.init) {
                    SkillForm.init = true;
                    var s = Serenity;
        ...
        SkillForm.formKey = 'Default.Skill';
        Default.SkillForm = SkillForm;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    ...
    (function (Default) {
        var SkillRow;
        (function (SkillRow) {
            SkillRow.idProperty = 'Id';
            SkillRow.nameProperty = 'Name';
            SkillRow.localTextPrefix = 'Default.Skill';
            SkillRow.lookupKey = 'Default.Skill';
            function getLookup() {
                return Q.getLookup('Default.Skill');
            }
            SkillRow.getLookup = getLookup;
        })(SkillRow = Default.SkillRow || (Default.SkillRow = {}));
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    ...
    (function (Default) {
        ...
        (function (SkillService) {
            SkillService.baseUrl = 'Default/Skill';
            [
                'Create',
                'Update',
                'Delete',
                ...
                SkillService[x] = function (r, s, o) {
                    return Q.serviceRequest(SkillService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(SkillService = Default.SkillService || (Default.SkillService = {}));
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
...
(function (SayugaSol) {
    ...
    SayugaSol.PhoneEditor = PhoneEditor;
    var PhoneEditor_1;
})(SayugaSol || (SayugaSol = {}));
...
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var CertificationDialog = (function (_super) {
            __extends(CertificationDialog, _super);
            function CertificationDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.CertificationForm(_this.idPrefix);
                return _this;
            }
            CertificationDialog.prototype.getFormKey = function () { return Default.CertificationForm.formKey; };
            CertificationDialog.prototype.getIdProperty = function () { return Default.CertificationRow.idProperty; };
            CertificationDialog.prototype.getLocalTextPrefix = function () { return Default.CertificationRow.localTextPrefix; };
            CertificationDialog.prototype.getNameProperty = function () { return Default.CertificationRow.nameProperty; };
            CertificationDialog.prototype.getService = function () { return Default.CertificationService.baseUrl; };
            return CertificationDialog;
        }(Serenity.EntityDialog));
        CertificationDialog = __decorate([
            Serenity.Decorators.registerClass(),
            Serenity.Decorators.responsive()
        ], CertificationDialog);
        Default.CertificationDialog = CertificationDialog;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var CertificationGrid = (function (_super) {
            __extends(CertificationGrid, _super);
            function CertificationGrid(container) {
                return _super.call(this, container) || this;
            }
            CertificationGrid.prototype.getColumnsKey = function () { return 'Default.Certification'; };
            CertificationGrid.prototype.getDialogType = function () { return Default.CertificationDialog; };
            CertificationGrid.prototype.getIdProperty = function () { return Default.CertificationRow.idProperty; };
            CertificationGrid.prototype.getLocalTextPrefix = function () { return Default.CertificationRow.localTextPrefix; };
            CertificationGrid.prototype.getService = function () { return Default.CertificationService.baseUrl; };
            return CertificationGrid;
        }(Serenity.EntityGrid));
        CertificationGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], CertificationGrid);
        Default.CertificationGrid = CertificationGrid;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var ContactsDialog = (function (_super) {
...
(function (SayugaSol) {
    var Default;
    (function (Default) {
        var ContactsGrid = (function (_super) {
    ...
    (function (Default) {
        var SkillDialog = (function (_super) {
            ...
            function SkillDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Default.SkillForm(_this.idPrefix);
                return _this;
            }
            SkillDialog.prototype.getFormKey = function () { return Default.SkillForm.formKey; };
            SkillDialog.prototype.getIdProperty = function () { return Default.SkillRow.idProperty; };
            SkillDialog.prototype.getLocalTextPrefix = function () { return Default.SkillRow.localTextPrefix; };
            SkillDialog.prototype.getNameProperty = function () { return Default.SkillRow.nameProperty; };
            SkillDialog.prototype.getService = function () { return Default.SkillService.baseUrl; };
            return SkillDialog;
        }(Serenity.EntityDialog));
        ...
        Default.SkillDialog = SkillDialog;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
    ...
    (function (Default) {
        var SkillGrid = (function (_super) {
            ...
            function SkillGrid(container) {
                return _super.call(this, container) || this;
            }
            SkillGrid.prototype.getColumnsKey = function () { return 'Default.Skill'; };
            SkillGrid.prototype.getDialogType = function () { return Default.SkillDialog; };
            SkillGrid.prototype.getIdProperty = function () { return Default.SkillRow.idProperty; };
            SkillGrid.prototype.getLocalTextPrefix = function () { return Default.SkillRow.localTextPrefix; };
            SkillGrid.prototype.getService = function () { return Default.SkillService.baseUrl; };
            return SkillGrid;
        }(Serenity.EntityGrid));
        SkillGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], SkillGrid);
        Default.SkillGrid = SkillGrid;
    })(Default = SayugaSol.Default || (SayugaSol.Default = {}));
})(SayugaSol || (SayugaSol = {}));
var SayugaSol;
(function (SayugaSol) {
